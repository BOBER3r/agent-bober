...
## Obsidian Vault Storage Layer — in progress (3 of 5)
...
SOPS wiring. **The `bober vault reindex` CLI now exists** (Sprint 3): it walks a vault directory,
...
excluded). The Obsidian MCP read/write adapter and the `profile.yaml`/SOPS hook remain Sprints 4–5.
