...
## Medical Ingest — Lab-PDF Parser — in progress (4 of 5)
...
are documented in the same three places. The Anthropic-only `documents` provider capability is noted in
