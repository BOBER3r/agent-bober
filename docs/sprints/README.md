...
## Priority Hub — in progress (3 of N)
...
fast path with **zero LLM calls**; the judge is **internal** (no CLI yet). `priority.md` + `decide`
(Sprint 4) and the chat hub surface (Sprint 5) remain explicit non-goals.
