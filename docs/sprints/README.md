...
auditor toolset stays read-only (git never becomes an auditor tool, ADR-5). The supply-chain
scanners (sprint 7) and the fresh-context finding verifier (sprint 8) remain.
