...
## Ultimate SEO Agent + Skill Suite — in progress (6 of 14; knowledge library complete, data plane begun)
...
peer the live `gsc`/`dataforseo` adapters (sprints 8-9) will sit beside. The later
