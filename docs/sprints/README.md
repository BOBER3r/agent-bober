...
historical-tagging and changelog-cut sprints were no-ops. **No git tags were created by this spec**
...
## One terminal vocabulary for `SprintContract` + the rank-aware channel join — in progress (1 of 6)
