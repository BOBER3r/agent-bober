...
## Security Auditor — Per-Stack Skills — in progress
...
for the scanner-only supply-chain case). It is purely additive, not wired into the gate. **Only the
sprint-10 dogfood/docs close-out now remains.**
