...
## Configurable documenter docs output (solo vs team) — 1 of 3 in progress
...
**byte-identical** to pre-sprint. Still pending: the md prompt surfaces (`agents/bober-documenter.md`,
`skills/bober.{sprint,run}/SKILL.md`) and the config reference — **sprint 2** — and the `bober init`
solo-vs-team question — **sprint 3**. Until sprint 2 lands, the skill-engine documenter path still
hardcodes `docs/sprints/` + commit.
