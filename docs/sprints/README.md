...
## Medical Ingest — Lab-PDF Parser — in progress (2 of 5)
...
Anthropic-only `documents` provider capability is noted in [`../providers.md`](../providers.md). The
medical data store this leg reindexes into (vault-canonical, store-as-derived-index) is described in
[`../teams.md`](../teams.md) under "Numerics + data store".
