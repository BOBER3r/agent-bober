...
## Ultimate SEO Agent + Skill Suite — in progress (5 of 14; knowledge library complete)
...
read-only detection guidance, enforced additionally by a new `FORBIDDEN_ACTION_PATTERNS` test guard. The later
sprints (analyzer 10, adapters, CLI, hub emitter) consume this corpus rather than add to it.
