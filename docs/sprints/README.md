...
## Telegram Frontend — in progress (Sprint 4)
...
`/decide X vs Y`) with their ephemeral-scope parsing and execa-to-hub delegation, and (Sprint 4) the
...
`sendKeyboard`/`answerCallback` transport extension) are documented in
