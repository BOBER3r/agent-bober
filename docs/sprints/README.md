...
## Priority Hub — in progress (4 of N)
...
dependency. The chat hub surface (Sprint 5) remains an explicit non-goal.
...
[`COMMANDS.md`](../../COMMANDS.md) (Hub Commands) and the README "Priority hub" command list.
