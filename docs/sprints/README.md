...
## Telegram Frontend — in progress (Sprint 6)
...
`bot.ts`-only. Live do-bridge wiring of `streamProgress` is left as a **documented seam**.
...
four chokepoints, all Sprint 1–5 callers byte-identical) are documented in
