...
## Ultimate SEO Agent + Skill Suite — in progress (10 of 14; knowledge library complete, data plane complete, analysis layer online)
...
evidence discipline as an agent prompt (primary-source IRON LAW, human-approval discipline, fail-closed parsing). The later sprints
(runner/CLI 11, verifier 12, hub emitter) consume this analysis stage rather than add to it.
