...
## Obsidian Vault Storage Layer — in progress (1 of 5)
...
SOPS wiring. Sprint 1 lays the **foundation only** — a new `src/vault/` module with the typed
...
The FactStore index, the `bober vault reindex` CLI, the Obsidian MCP adapter, and the
`profile.yaml`/SOPS hook are **deferred to sprints 2–5**. **+18 tests (full suite 2849), no new
deps, all five criteria (sc-1-1..sc-1-5) passed iteration 1.**
