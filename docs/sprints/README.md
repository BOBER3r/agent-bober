...
## Telegram Frontend — in progress (Sprint 3)
...
plain-text capture**, and (Sprint 3) the **scoped hub-priority commands** (`/today`, `/priority`,
`/decide X vs Y`) with their ephemeral-scope parsing and execa-to-hub delegation are documented in
